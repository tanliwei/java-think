 ...
 * @create 2018/7/13
 */
public class CollectionGenTest2<T extends Collection> {

    private T x;

    public CollectionGenTest2(T x) {
        this.x = x;
    }
...
//        CollectionGenTest<Object> a;
        CollectionGenTest2<ArrayList> myArr = null;
        //下面这行代码编译出错： can not infer argument
//        myArr = new CollectionGenTest<>(new LinkedList());
        myArr = new CollectionGenTest2<>(new ArrayList());
        myArr.getX().add("a");

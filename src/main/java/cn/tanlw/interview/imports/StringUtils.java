...
package cn.tanlw.interview.imports;
...
public abstract class StringUtils {
	...
	/**
	 * TestDemo if the given {@code String} starts with the specified prefix,
	...
	/**
	 * TestDemo if the given {@code String} ends with the specified suffix,
	 * ignoring upper/lower case.
	 * @param str the {@code String} to check
	...
	/**
	 * TestDemo whether the given string matches the given substring
	 * at the given index.

...
public class StringHelper {
     ...
     * @param limit
     */
    public static void checkLengthOptional(String content,String name, int limit) {
        if (!StringUtils.isEmpty(content) && content.length() > limit) {
            throw new IllegalArgumentException(name + "超过长度限制:"+limit);
        }
    }
